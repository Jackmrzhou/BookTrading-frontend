<template>
    <div id="RequestBookMain">
        <el-row>
            <el-col :xs="24" :xl="4" :lg="4">
                <CenterMenu></CenterMenu>
            </el-col>
            <el-col :xl="4" :lg="4" :xs="0">&nbsp;</el-col>
            <el-col :xl="10" :lg="10" :xs="24" style="margin-top: 40px;">
                <el-form :model="BookFormModel" ref="BookForm" label-position="left" label-width="80px">
                  ...
                  <el-form-item label="ISBN"><el-input v-model="BookFormModel.ISBN" placeholder="非必须"></el-input></el-form-item>
                  ...
                  <el-form-item label="介绍"><el-input v-model="BookFormModel.introduction" placeholder="好好描述一下你要的书的信息吧" type="textarea"></el-input></el-form-item>
                  <el-form-item>
                      <el-button type="success" @click="submit" round>
                          <span>发出请求</span>
                      </el-button>
                  </el-form-item>
                </el-form>
